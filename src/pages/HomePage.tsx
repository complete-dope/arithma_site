          ...
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div className="@container">
              <div className="@[480px]:p-4">
                ...
                >
                  ...
                  <Button className="min-w-[84px] max-w-[480px] h-10 px-4 @[480px]:h-12 @[480px]:px-5 bg-[#1993e5] text-white text-sm font-bold leading-normal tracking-[0.015em] @[480px]:text-base @[480px]:font-bold @[480px]:leading-normal @[480px]:tracking-[0.015em]">
                    Get Started
                  </Button>
                </div>
              </div>
            ...
            <div className="flex overflow-y-auto [-ms-scrollbar-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              <div className="flex items-stretch p-4 gap-3">
                <Card className="flex h-full flex-1 flex-col gap-4 rounded-lg min-w-60">
                  <CardHeader className="w-full bg-center bg-no-repeat aspect-square bg-cover rounded-lg flex flex-col p-0"
                  ...
                  <CardContent className="flex flex-col gap-2 p-4">
                    <CardTitle className="text-[#111518] text-base font-medium leading-normal">Budgeting Basics</CardTitle>
                    <CardDescription className="text-[#637988] text-sm font-normal leading-normal">Create a personalized budget to track your spending and savings.</CardDescription>
                  </CardContent>
                </Card>
                <Card className="flex h-full flex-1 flex-col gap-4 rounded-lg min-w-60">
                  <CardHeader className="w-full bg-center bg-no-repeat aspect-square bg-cover rounded-lg flex flex-col p-0"
                  ...
                  <CardContent className="flex flex-col gap-2 p-4">
                    <CardTitle className="text-[#111518] text-base font-medium leading-normal">Investment Strategies</CardTitle>
                    <CardDescription className="text-[#637988] text-sm font-normal leading-normal">Learn how to build a diversified investment portfolio for long-term growth.</CardDescription>
                  </CardContent>
                </Card>
                <Card className="flex h-full flex-1 flex-col gap-4 rounded-lg min-w-60">
                  <CardHeader className="w-full bg-center bg-no-repeat aspect-square bg-cover rounded-lg flex flex-col p-0"
                  ...
                  <CardContent className="flex flex-col gap-2 p-4">
                    <CardTitle className="text-[#111518] text-base font-medium leading-normal">Debt Management</CardTitle>
                    <CardDescription className="text-[#637988] text-sm font-normal leading-normal">Develop a plan to pay off your debts and improve your credit score.</CardDescription>
                  </CardContent>
                </Card>
              </div>
            </div>
            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-4">
              <Card className="flex flex-col gap-3 pb-3">
                <CardHeader className="w-full bg-center bg-no-repeat aspect-video bg-cover rounded-lg p-0"
                  style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuBDqwY_3WneRn8dCJGqQZ6AO68axPTZ5ijpR3vALEhnaQ4eVNwFdvViEU0YecDzqlYa5YeSKugxcZ87oKpu9N0SIGkRogyIU3aabaPbdT3ZwJnymNWrpCGVwYaUH-bmHYOELEIpAMMXxjUA2pQYyqX8yRlUUK_6c9_uAAL7cPXPSClU30yYBi5kh8zhi64ldxw3DUhP3XvAC4jJsRe2wKFFKECe40SLGXa7-veEpiFiqXQGAHPAfCRA")' }}
                >
                </CardHeader>
                <CardContent className="flex flex-col gap-2 p-4">
                  <CardTitle className="text-[#111518] text-base font-medium leading-normal">The Ultimate Guide to Saving for a Down Payment</CardTitle>
                  <CardDescription className="text-[#637988] text-sm font-normal leading-normal">Learn how to save effectively for your dream home.</CardDescription>
                </CardContent>
              </Card>
              <Card className="flex flex-col gap-3 pb-3">
                <CardHeader className="w-full bg-center bg-no-repeat aspect-video bg-cover rounded-lg p-0"
                ...
                <CardContent className="flex flex-col gap-2 p-4">
                  <CardTitle className="text-[#111518] text-base font-medium leading-normal">Investing in Cryptocurrency: Risks and Rewards</CardTitle>
                  <CardDescription className="text-[#637988] text-sm font-normal leading-normal">Understand the potential benefits and risks of investing in digital currencies.</CardDescription>
                </CardContent>
              </Card>
              <Card className="flex flex-col gap-3 pb-3">
                <CardHeader className="w-full bg-center bg-no-repeat aspect-video bg-cover rounded-lg p-0"
                ...
                <CardContent className="flex flex-col gap-2 p-4">
                  <CardTitle className="text-[#111518] text-base font-medium leading-normal">Building a Strong Credit Score: Tips and Tricks</CardTitle>
                  <CardDescription className="text-[#637988] text-sm font-normal leading-normal">Discover the key factors that influence your credit score and how to improve it.</CardDescription>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="flex overflow-y-auto [-ms-scrollbar-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              <div className="flex items-stretch p-4 gap-3">
                <Card className="flex h-full flex-1 flex-col gap-4 rounded-lg min-w-60">
                  <CardHeader className="w-full bg-center bg-no-repeat aspect-[3/4] bg-cover rounded-lg p-0"
                  ...
                  <CardContent className="flex flex-col gap-2 p-4">
                    <CardTitle className="text-[#111518] text-base font-medium leading-normal">5 Personal Finance Tips You Need to Know</CardTitle>
                    <CardDescription className="text-[#637988] text-sm font-normal leading-normal">Quick and actionable tips to improve your financial health.</CardDescription>
                  </CardContent>
                </Card>
                <Card className="flex h-full flex-1 flex-col gap-4 rounded-lg min-w-60">
                  <CardHeader className="w-full bg-center bg-no-repeat aspect-[3/4] bg-cover rounded-lg p-0"
                  ...
                  <CardContent className="flex flex-col gap-2 p-4">
                    <CardTitle className="text-[#111518] text-base font-medium leading-normal">Investing for Beginners: A Step-by-Step Guide</CardTitle>
                    <CardDescription className="text-[#637988] text-sm font-normal leading-normal">Get started with investing with this easy-to-follow guide.</CardDescription>
                  </CardContent>
                </Card>
                <Card className="flex h-full flex-1 flex-col gap-4 rounded-lg min-w-60">
                  <CardHeader className="w-full bg-center bg-no-repeat aspect-[3/4] bg-cover rounded-lg p-0"
                  ...
                  <CardContent className="flex flex-col gap-2 p-4">
                    <CardTitle className="text-[#111518] text-base font-medium leading-normal">How to Tackle Your Debt and Achieve Financial Freedom</CardTitle>
                    <CardDescription className="text-[#637988] text-sm font-normal leading-normal">Strategies to manage and eliminate your debt effectively.</CardDescription>
                  </CardContent>
                </Card>
              </div>
            </div>
